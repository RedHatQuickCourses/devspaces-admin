...
This course is the second in a series of 5 courses about Red Hat OpenShift Dev Spaces. This course covers how to install, update and uninstall Red Hat OpenShift Dev Spaces and perform basic administration tasks.
...
```
    $ git clone git@github.com:RedHatQuickCourses/devspaces-admin.git
```
...
If you run into any issues, report bugs/suggestions/improvements about this course here - https://github.com/RedHatQuickCourses/devspaces-admin/issues
