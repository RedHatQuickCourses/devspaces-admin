...
› Current Kubernetes context: 'default/api-cluster-5knwp-5knwp-sandbox1524-opentlc-com:6443/admin'
  ...
  ✔ Show important messages
    ✔ Red Hat OpenShift Dev Spaces 3.27.1 has been successfully deployed.
    ...
...
----
$ *dsc server:status*
Red Hat OpenShift Dev Spaces Version    : 3.27.1
Red Hat OpenShift Dev Spaces Url        : https://devspaces.apps.cluster-5knwp.5knwp.sandbox1524.opentlc.com/dashboard/
----

== References

* https://docs.redhat.com/en/documentation/red_hat_openshift_dev_spaces/3.27.1/html-single/administration_guide/index#installing-devspaces-on-openshift-using-cli[Installing Dev Spaces on OpenShift using CLI^]