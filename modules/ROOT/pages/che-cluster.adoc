...
Refer to the https://docs.redhat.com/en/documentation/red_hat_openshift_dev_spaces/3.27/html-single/administration_guide/index#ref_checluster-custom-resource-fields_administration_guide[CheCluster Custom Resource fields reference^] for the full list of attributes and values that can be changed.
...
You can increase this value by editing an attribute in the `CheCluster` CR. See https://docs.redhat.com/en/documentation/red_hat_openshift_dev_spaces/3.27/html-single/administration_guide/index#proc_enabling-multiple-workspaces-simultaneously_administration_guide[window=_blank].
