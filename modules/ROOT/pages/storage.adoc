...
* https://docs.redhat.com/en/documentation/red_hat_openshift_dev_spaces/3.27/html/administration_guide/assembly_configuring-storage_administration_guide[Configuring Storage for Dev Spaces Workspaces^]
* https://docs.redhat.com/en/documentation/red_hat_openshift_dev_spaces/3.27/html/administration_guide/assembly_configuring-storage_administration_guide#proc_configuring-storage-strategy_administration_guide[Configure the storage strategy ^]
